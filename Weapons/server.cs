...
package asdf
{
	//function StuffItem::onPickup(%a,%b,%c)
	//{
	//	talk("ITEM PICKUP - " @ %a SPC %b SPC %c);
	//	parent::onPickup(%a,%b,%c);	
	//}
	
	//function StuffItem::onUse(%a,%b,%c)
	//{
	//	talk("ITEM USE - " @ %a SPC %b SPC %ce);
	//	parent::onUse(%a,%b,%c);
	//}
		
	//function StuffItem::onInventory(%a,%b,%c,%d,%e)
	//{
	//	talk("ITEM INVENTORY - " @ %a SPC %b SPC %c SPC %d SPC %e);
	//	parent::onInventory(%a,%b,%c,%d,%e);
	//}
	
	//function Player::onInventory(%a,%b,%c,%d,%e)
	//{
	//	talk("PLAYER INVENTORY - " @ %a SPC %b SPC %c SPC %d SPC %e);
	//	parent::onInventory(%a,%b,%c,%d,%e);
	//}
